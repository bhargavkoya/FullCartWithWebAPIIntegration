...
namespace e_commerce.Controllers
{
    public class AddressesController : Controller
    {
        ...
        string AddressURL = "https://localhost:44366/api/Addresses/";
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var customerList = JsonConvert.DeserializeObject<DbSet<Customer>>(await client.GetStringAsync(CustomerURL)).ToList();
            ViewData["CustId"] = new SelectList(customerList, "UserId", "Email", address.CustId);
            return View(address);
        }
